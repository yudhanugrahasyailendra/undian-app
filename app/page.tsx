  ...
  return (
    <div className={`flex ${isFullscreen ? "fixed top-0 left-0 w-full h-full" : "min-h-screen"} p-2`} style={{ backgroundColor: "#D1399B" }}>
      ...
      <div className="flex flex-col items-center justify-center flex-grow">
        ...
        <h1 className="text-3xl md:text-5xl font-bold mb-3 text-white text-center">Pemenangnya Adalah</h1>
        <div className="bg-white text-pink-600 px-4 md:px-6 py-2 md:py-3 rounded-lg shadow-md text-5xl md:text-8xl font-semibold">
          {winner || "Winner ?"}
        </div>
        <div className="mt-6 flex space-x-4">
          <button onClick={handleToggle} className={`px-10 md:px-20 py-2 md:py-4 text-xl md:text-2xl text-white rounded-lg ${isRolling ? "bg-red-500 hover:bg-red-600" : "bg-green-500 hover:bg-green-600"}`}>
